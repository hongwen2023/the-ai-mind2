...
| [`code/`](code/) | 第 1–15 章配套代码 + 回归测试 + 锁定依赖（见 `code/README.md`） |

> **Book I（智能与计算的基础，Ch1–Ch7）与 Book II（学习的数学，Ch8–Ch15）均已完整交付。** Book II 收官时 **Ch7 的四张欠条全部结清**：梯度推导(Ch9)、交叉熵合法性(Ch12)、GD 收敛(Ch14)、泛化界(Ch15)。Prelude P.1、架构、自评见上表。
...
pytest -q                             # 跑全部数值回归测试（ch01–ch15，73 项）
```
